...
exports.scanWorkspaceForSecrets = scanWorkspaceForSecrets;
const fs = require("fs");
const path = require("path");
function scanWorkspaceForSecrets(rootPath, detector, maxFiles = 50) {
...
//# sourceMappingURL=workspaceScan.js.map